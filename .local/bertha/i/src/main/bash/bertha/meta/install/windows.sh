...
mv -n "${NEKO_TGT}" "${BERTHA_PATH}/.local/bertha/o/tmp/${NEKO_REMOTE_FILENAME}"
#Windows 10 build 17063 or later 
tar -xf "${BERTHA_PATH}/.local/bertha/o/tmp/${NEKO_REMOTE_FILENAME}" --directory "${BERTHA_PATH}/.local/bertha/o/os/windows/prg"